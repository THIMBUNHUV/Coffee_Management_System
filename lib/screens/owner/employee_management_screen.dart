...
//                               ),
//                               child: Text(
//                                 '\$${employee.salary!.toStringAsFixed(0)}', // No decimals to save space
//                                 style: const TextStyle(
//                                   color: Colors.green,
//                                   fontSize: 10,
//                                   fontWeight: FontWeight.w600,
...
//           const SizedBox(width: 12),
//           Text(text, style: const TextStyle(color: Color(0xFF7F8C8D))),
//         ],
//       ),
//     );
//   }
...
//   //                               await _databaseHelper.insertEmployee(newEmployee);
//   //                             } else {
//   //                               // Update existing employee in database
//   //                               await _databaseHelper.updateEmployee(newEmployee);
//   //                             }
