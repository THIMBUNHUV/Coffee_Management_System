...
// class _OwnerProductManagementScreenState
//     extends State<OwnerProductManagementScreen> {
//   @override
//   void initState() {
//     super.initState();
//     _loadProducts();
...
//                     ),
//                     child: Text(
//                       '${productProvider.products.length} ${productProvider.products.length == 1 ? 'product' : 'products'}',
